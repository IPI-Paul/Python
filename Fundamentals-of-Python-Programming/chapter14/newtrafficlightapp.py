# Listing 14.11
# I our final installment of the button-controlled traffic light image found in
# Listing 9.14, Listing 13.9, and Listing 14.2
...
class NewTrafficLightApp:
    """
    Graphical window that displays a traffic light and chnage button
    """
