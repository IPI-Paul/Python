# Listing 14.20
# A class that represents a graphical object that a user may reposition within a
...
class GraphicalObject(Top):
    """
    A graphical object that allows the user to reposition it anywhere within the 
    window using the mouse. Contains all the code to manage Turtle graphics 
    environment
    """
    def __init__(self, **kwargs):
        """
        Initialises a GraphicalObject object 
        ...
        print('Intialising graphical object')
