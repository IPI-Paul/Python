# Listing 14.25
# Defines a class named MovableTimer that inherits from both DigitalTimer and 
# GraphicalObject
...
class MovableTimer(GraphicalObject, DigitalTimer):
    """
    A graphical digital timer that allows the user to reposition its display 
    anywhere within the window using the mouse. Contains all the code to manage 
    ...
    def __init__(self, **kwargs):
        ...
        print('Initialising MovableTimer')
        self.screen.listen()                        # Receive key press events
    ...
    def update(self):
        """
        Updates the program's view of the global stopwatch object. Called every
        half a second
        """
        self.draw()     # Draw the digital display
        # Call the update function again after half a second 
