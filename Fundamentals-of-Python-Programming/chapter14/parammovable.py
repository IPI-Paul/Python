# Listing 14.16
# Allows the user to select the type of light to manipulate
...
class ParameterizedMovable:
    """
    Graphical window that allows a user to move and resize a traffic light object
    """
    
    def __init__(self, light_class):
        """
        Creates a ParameterizedLightTester.
        light_class: is the type of light to create, it must be MovableLight or 
    ...
    def mouse_pressed(self, event):
        """
        The window manager calls this function when the user presses the mouse
        """
...
print('What kind of light do you want to play with?')
