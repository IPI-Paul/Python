# Listing 7.17
# Uses a function named get_int_in_range that does not return until the user 
# supplies a proper value
...
def get_int_in_range(first, last):
    ...
    last is the corresponding other end of the range, either a maximum or 
    minimum value.
    Returns an acceptable value from the user.
    """
    # If the larger number is provided first, switch the parmeters
    if first > last:
