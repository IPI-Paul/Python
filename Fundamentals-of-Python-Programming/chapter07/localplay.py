# Listing 7.9
# Illustrates how function definitions provide protection for local variables
...
def fun1():
    x = 10
    print('2. x =', x)      # Print variable x's current value
    
print('3. x =', x)      # Print variable x's current value

def fun2():
    x = 20
    print('4. x =', x)      # Print variable x's current value
