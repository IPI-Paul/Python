# Listing 15.11
# Demonstrates the unwinding power of recursion
...
def rec(n, depth):
    """
    Prints the value of the parameter n and local variable rand before and after
    the recursive call
    n: is the paremeter of interest
