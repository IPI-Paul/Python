# Listing 15.3
# Provides the complete Python implementation of the selection_sort
...
def random_list():
    ...
    pseudorandomly in the range 3-20. the integers in the list range from -50 
    to 50
    """
    result = []
    count = randint(3, 20)
...
def selection_sort(lst):
    """
    Arranges the elements of list lst in ascending order. Physically rearranges 
    the elements of lst
    """
    n = len(lst)
    for i in range(n - 1):
