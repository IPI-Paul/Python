# Listing 15.13
# Contains functions that build a new list containing all the permutations of a 
# given list
...
def perm(lst, begin, result):
    ...
    given list (lst_), beginning with a specified index (begin). This is a 
    helper function for the permutations function
    """
