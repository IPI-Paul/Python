...
def perm(lst, begin):
    """
    Generates the sequence of all permutations of the elements of a given list 
    (lst), beginning with specified index (begin). This is a helper function 
    ...
    if begin == end:
        ...
        for i in range(begin, end + 1): # Consider all indices
            # Interchange the element at the first position with the element
            # at position i
...
def permutations(lst):
    """
    Generates the sequence of all the permutations of the elements of list lst. 
