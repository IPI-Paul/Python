# Listing 15.5
# Uses a function named locate that returns the position of the first occurence
# of a given element in a list; if the element is not present, the function 
# returns None
...
def draw_arrow(value, n):
    ...
    n: sepcifies the horizontal offset of the arrow
    """
