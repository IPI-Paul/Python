# Listing 15.23
# Uses a dictionary to cache previously computed Fibonacci numbers. It 
# demonstrates the dramatic sppedup that memoization affords
...
def fibonacci2(n):
    """
    Returns the nth Fibonacci number. Caches a recursively computed result to be 
    used when needed in the future. Provides a huge performance improvement over
