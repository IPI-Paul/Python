# Listing 15.2
# Does not call either Python function but rather plots the 
# f(n) = (n**2 - n) / 2 and f(n) = n - 1 mathematical functions over the same 
# range of values as the list sizes tested in Listing 15.1
...
def main():
    """
    Compares the theoretical performance of the is_ascending and is_ascending2 
    functions on lists of various sizes
    """
    data1, data2 = [], []
