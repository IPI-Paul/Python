...
t2 = Turtle()           # Create asecond turtle object named t2
t1.pencolor('red')      # t1's pen color is red
t2.pencolor('blue')     # t2's pencolor is blue
t2.left(90)             # Point t2 up (t1 aoutomatically points to the right)
