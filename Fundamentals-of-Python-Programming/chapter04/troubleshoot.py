# Listing 4.14
# Implements a very simple toubleshooting program that an (equally simple) 
# computer technician might use to diagnose an ailing computer
        ...
        if choice == 'n':   # The switch is off, turn it on!
            ...
            if choice == 'n':   # No fuse
                ...
                if choice == 'n':   # Fix outlet
                    ...
                    print("to a new outlet, if necessary. If the problem ")
                    print("persists, please run this program again.")
                else:   # Beats me!
                    print("Please consult a service technician.")
            else:   # Check fuse
                print("Check the fuse. Replace if necessary. If the problem ")
                print("persists, then please run this program again.")
