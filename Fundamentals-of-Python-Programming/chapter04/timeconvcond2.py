# Listing 4.16
# Uses if/else statements to express time units with the correct number, but 
# will not print a value and it's associated time unit if the value is zero
...
if minutes > 0:         # Print minutes at all?
    print(minutes, end='')
    # Decide between singular ans plural for of minutes
    if minutes == 1:
        print(' minute ', end='')
    else:
        print(' minutes ', end='')
