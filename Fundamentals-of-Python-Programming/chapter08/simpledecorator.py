# Listing 8.29
# Shows how we can use the show_call_and_return_details function to achieve the 
# goal of printing details about function calls without modifying the code of 
...
def show_call_and_return_details(f):
    """
    Decorates function f so its call will display the parameter values and 
    return value.
    """
    func_name = f.__name__  # Get the functions's name
...
print(randrange(10, 21), 'is a pseudorandom integer in the range 10 to 20, ' +
      'inclusive')