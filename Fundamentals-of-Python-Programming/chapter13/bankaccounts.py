# Listing 13.5
# Uses a BankAccount class to implement a simple database of customer bank 
# accounts.
...
class BankAccount:
    ...
    def __init__(self, number, name, balance):
        """
        Initialise the instance variables of a bank account object. Disallows a 
    ...
    def withdraw(self, amount):
        """
        Remove funds from the account, if possible. Only completes the withdrawal
        successfully if there are enough funds in the account to fulfill the 
        withdrawal. Return true if successful, false otherwise.
        """
        result = False  # Unsucessful by default
...
def print_database(db):
    ...
    """
    for acct in db:
        print(acct)     # Calls the __str__ mothod of acct
...
def main():
    ...
    try:
        ...
        if customer:
            ...
            print('Account 129 after withdraw of $100:  ', end='')
            print(customer)
            print('----------------------')
