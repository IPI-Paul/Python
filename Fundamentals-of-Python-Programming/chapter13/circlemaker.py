# Listing 13.2
# Exercises the new Circle class. It uses Turtle graphics to render Circle 
...
def draw_circle(t, circle):
    x, y = circle.get_center()      # Unpack circle's coordinates
...
def main():
    ...
    t.speed(0)                      # Make turlte's actions as fast as possible
