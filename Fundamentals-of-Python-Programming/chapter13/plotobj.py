# Listing 13.14
# Defines a class named Plotter that enables plotting of data obtained 
# experimentally
...
class Plotter:
    ...
    def draw_arrow(self, x1, y1, x2, y2):
        ...
        # Draw arrow shaft
        self.pen.up()
        self.pen.setposition(x1, y1)    # move the pen to the starting point
        self.pen.down()     # Draw a line from bottom to top
        self.pen.setposition(x2, y2) # Move the pen to the starting point
        # Draw arrow head
        dy = y2 - y1
        dx = x2 - x1
