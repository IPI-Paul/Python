# Listing 13.11
# Further demonstrates the flexibility of our TrafficLight class by creating  
# 50 traffic light objects at random positions with random sizes
...
class RandomLightsWindow:
    """
    Graphical window that displays multiple traffic lights of different sizes.
    """
