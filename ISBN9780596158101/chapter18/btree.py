...
# Example 18-14
# Shows what it means in code whereby, instead of coding disticnt search 
# functions, binary trees are constructed with "smart" objects--class instances 
# that know how to handle insert/lookup and printing requests and pass them to 
# subtree objects
# Author: Mark Lutz
# Last modified: 
