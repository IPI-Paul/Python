...
# Example 10-17
# Exercises Example 10-16s classes in a variety of modes--as mix-in classes, as 
# superclasses, and as calls from nonclass code
# Author: Mark Lutz
# Last modified: 
...
def _selftest():
    # mixin usage
    class content:
        "same code as a Tk, Toplevel, and Frame"
        def __init__(self):
