...
# Example 10-21
# Is a revision of the prior example's self-test using classes and methods
# Author: Mark Lutz
# Last modified: 

# tests thread callback queue, but uses class bound mehtods for action and callbacks
