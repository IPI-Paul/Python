...
# Example 10-9
# This module and its client script in Example 10-10 use custom modal dialog 
# techniques to pop up an input display to collect pack script parameters
# Author: Mark Lutz
# Last modified: 

"""
create a label+entry row frame, with optional file open browse button; this is a
separate module because it can save code in other programs too; caller (or 
callbacks here): retain returned linked var while row is in use
"""
