...
# Example 10-1
# Codes functions that provide typical widget configurations, and automate the 
# construction process for cases to which they apply
# Author: Mark Lutz
# Last modified: 
...
assumptions (e.g., expansion); use **extras fkw args for width, font/color, etc., 
and repack result manually later to override defaults if needed
################################################################################
"""
