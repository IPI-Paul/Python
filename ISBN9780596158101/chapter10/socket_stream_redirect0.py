...
# Example 10-23
# Encapsulates the client-side socket connection used by non-GUI code for reuse.
# Author: Mark Lutz
# Last modified: 

"""
[partial] Tools for connecting streams of non-GUI programs to sockets that a GUI 
(or other) can use to interact with the non-GUI program; see Chapter 12 and 
PP4E\Sockets\Internet for a more complete treatment
"""
...
def redirectOut(port=port, host=host):
    ...
    start caller after listner started, else connect fails before accept
    """
