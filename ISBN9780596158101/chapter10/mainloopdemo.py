...
# Example 10-22
# Shows one way to code popping up GUI windows on demand
# Author: Mark Lutz
# Last modified: 
...
widget and then run just one mainloop, and have all their logic in callbacks; 
this demo uses mainloop calls to implement two modal user interfaces from a 
non-GUI main program; it shows one way to add a GUI component to an exisiting 
non-GUI script, without restructuring code;
"""
