...
# Example 16-7
# The password from it's input page is shipped to this script
...
MaxHdr = 35                             # max lentgh of email hdrs in list
...
try:
    ...
    lpop = ('lpop' in formdata and formdata['lpop'].value) or 'off'
