...
# Example 15-21
# Is a utility module to which the dummy class is moved
# Author: Mark Lutz
# Last modified: 

"""
Tools for simulating the result of a cgi.FieldStorage() call; useful for testing
CGI scripts outside the web
"""
