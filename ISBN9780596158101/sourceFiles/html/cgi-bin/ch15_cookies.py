...
# Example 15-16
# Lists a CGI script that stores a client-side cookie when first visited and 
# receives and displays it on subsequent visits.
# Author: Mark Lutz
# Last modified: 

"""
create or use a client-side cookie storing username; there is no input form data
to parse in this example
"""
