...
# Example 12-18
# Uses form construction techniques to create a dialog for inputting server, port,
# and filename information, and simply constructs the corresponding getfile 
# command and runs it with the os.system call
# Author: Mark Lutz
# Last modified: 
