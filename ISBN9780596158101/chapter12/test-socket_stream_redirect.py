...
# Example 12-11
# Defines five sets of client/server functions. It runs the client's code in process, 
# but deploys the Python multiprocessing module met in Chapter 5 to portably spawn
# the server function's side of the dialog in a separate process
# Author: Mark Lutz
# Last modified: 
