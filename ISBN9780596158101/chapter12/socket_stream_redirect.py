...
# Example 12-10
# Implements a variety of redirection schemes, which redirect the caller's 
# streams to a socket that can be used by another process for communication.
# Author: Mark Lutz
# Last modified: 

"""
################################################################################
Tools for connecting standard streams of non-GUI programs to sockets that a GUI
(or other) program can use to interact with the non-GUI program.
################################################################################
"""
