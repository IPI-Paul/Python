...
# Example 12-9
# Implements another echo server, one that can handle multiple clients without 
# ever starting new processes or threads
# Author: Mark Lutz
# Last modified: 

"""
Server: handle mu;tiple clients in parallel with select. use the select module to 
manually multiplex among a set of sockets: main sockets which accept new client 
connections, and input sockets connected to accepted clients; select can take an
optional 4th arg--0 to poll, n.m to wait seconds, or omitted to wait till any 
socket is ready for processing.
"""
