...
# Example by IPI-Paul.
# This script acts as a simple NTP server
# Author: github.com/limifly, Paul I Ighofose
...
def system_to_ntp_time(timestamp):
    ...
    Parameters: timestamp -- timestamp in system time
    Returns: corresponding NTP time
    """
    return timestamp + NTP.NTP_DELTA

def _to_init(timestamp):
    """
    Return the integral part of a timestamp.
    Parameters: timestamp -- NTP timestamp
...
class NTP:
    ...
    """
    _SYSTEM_EPOCH = datetime.date(*time.gmtime(0)[0:3])     # system epoch
    _NTP_EPOCH = datetime.date(1900, 1, 1)                  # NTP epoch
    # delta between system and NTP time
    NTP_DELTA = (_SYSTEM_EPOCH - _NTP_EPOCH).days * 24 * 3600   
    
    REF_ID_TABLE = {                                # reference identifier table 
        'DNC'       : 'DNC routing protocol',
        'NIST'      : 'NIST public modem',
        'TSP'       : 'TSP time protocol',
        'DTS'       : 'Digital Time Service',
        'ATOM'      : 'Atomic clock (calibrated)',
        'VLF'       : 'VLF radio (OMEG, etc)',
        'callsign'  : 'Generic radio',
        'LORC'      : 'LORAN-C radionavidation',
        'GOES'      : 'GOES UHF environment satelite',
        'GPS'       : 'GPS UHF satelite positioning',
        }
    
    STRATUM_TABLE = {                               # stratum table
        0: 'unspecified',
        1: 'primary reference',
        }
    ...
    LEAP_TABLE = {                                  # leap indicator table
        0: 'no warning',
...
class NTPPacket:
    """
    NTP packet class.
    This represents and NTP packet.
    """
    _PACKET_FORMAT = '!B B B b 11I'             # packet format to pack/unpack
    ...
    def __init__(self, version=2, mode=3, tx_timestamp=0):
        ...
        self.ref_timestamp = 0                  # refernece timestamp
    ...
    def to_data(self):
        ...
        Returns: buffer representing this packet
    ...
    def from_data(self, data):
        ...
        Parameters: data -- buffer payload
        ...
        self.rec_timestamp = _to_time(unpacked[11], unpacked[12])
