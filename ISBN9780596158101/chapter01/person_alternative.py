...
# Example 1-17
# Calls the superclass's constructor explicitly to fill in the Job field
# Author: Mark Lutz
# Last modified: 

"""
Alternative implementation of person classes, with data, behaviour, and operator
oveloading (not used for objects stored persistently
"""
