...
# Example 6-4
# Implements general tree scans, outfitter for the heavier lifting required for 
# scanning drives
# Author: Mark Lutz
# Last modified: 

"""
Find the largest file of a given type in an arbitrary directory tree. Avoid 
repeat paths, catch errors, add tracing and line count size. Also uses sets, 
file iterators and generator to avoid loading entire file, and attempts to work 
around undecodable dir/file name prints.
"""
