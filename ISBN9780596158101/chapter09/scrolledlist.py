...
# Example 9-9
# Builds both a Listbox and a Scrollbar, as a package set
# Author: Mark Lutz
# Last modified: 
...
class ScrolledList(Frame):
    ...
    def makeWidgets(self, options):
        ...
        #list.config(selecmode=SINGLE, setgrid=1)   # select, resize modes
        list.bind('<Double-1>', self.handleList)    # set event handler
        self.listbox = list
    
    def runCommand(self, selection):                # redefineme lower
