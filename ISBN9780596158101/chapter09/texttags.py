...
# Example 9-12
# Applies formatting and event bindings to three tagged substrings, displays text 
# in two different font and color schemes, and embeds an image and a button. 
# Double-clicking any of the tagged substrings (or the embedded button) with a 
# mouse triggers an event that prints to stdout
# Author: Mark Lutz
# Last modified: 
...
text.insert(END, '\n\n')
img = PhotoImage(file='../sourceFiles/images/queen-of-hearts.gif')
