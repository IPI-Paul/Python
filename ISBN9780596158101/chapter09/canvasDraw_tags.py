...
# Example 9-30
# Customizes the canvasDraw object creators for tags and add new event bindings 
# and actions
# Author: Mark Lutz
# Last modified: 

"""
add tagged moves with time.sleep (not widget.after or threads); time.sleep does 
not block the GUI event loop while pausing, but screen not redrawn until callback 
returns or widget.update call; currently running onMove callback has exclusive 
attention until it returns: others pause if press 'r' or 'o' during move
"""
