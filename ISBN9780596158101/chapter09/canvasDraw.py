...
# Example 9-16
# Shows how to bind additional events for the canvas itself, in order to implement
# a few of the more common canvas drawing operations
# Author: Mark Lutz, Paul I Ighofose
# Last modified: 2018-11-24

"""
draw elastic shapes on canvas on drag, move on right click; see 
canvasDraw_tags*.py for extensions with tags and animation
"""
