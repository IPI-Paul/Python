...
# Example 13-7
# Is a simple mutation of the prior chapter's user interface, implemented as a 
# new subclass of the preceeding chapter's general form builder 
# Author: Mark Lutz
# Last modified: 
...
directory path prefix); runs getfile.getfile in thread to allow more than one to
be running at once and avoid blocking GUI during downlooaads; this differs from
socket-based getfilegui, but reuses Form GUI builder tool; supports both user 
and anonymous FTP as currently coded;
...
sys.path.append('..')
from chapter12.form import Form             # reuse form tool in socket dir
