...
# Example 8-36
# Shows one way to code check button and radio button bars as library components.
# It encapsulates the notion of associating tkinter variables and imposes a 
# common usage mode on callers
# Author: Mark Lutz
# Last modified: 

"""
check and radio bar classes for apps that fetch state later; pass a list of 
options, call state(0, variable details automated
"""
