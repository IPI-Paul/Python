...
widget.config(bg='yellow', font=labelfont)          #  yellow background, large font
widget.config(height=5, width=20)                   # intial size: lines, chars
widget.pack(expand=YES, fill=BOTH)

widget.bind('<Button-1>', onLeftClick)              # mouse button clicks
widget.bind('<Button-2>', onRightClick)
widget.bind('<Button-3>', onMiddleClick)            # middle=both on some mice
