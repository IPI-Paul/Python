...
# Example 5-14
# Spawns two consumer threads that watch for data to appear on the shared queue
# and four producer threads that place data on the queue periodically after a 
# sleep interval
# Author: Mark Lutz
# Last modified: 
