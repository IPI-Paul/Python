...
# Example 5-20
# Distinguishes messages by mandating a separator character in the pipe. Wraps 
# the pipe descriptor in a file object with os.fdopen and relies on the file 
# object's readline method to scan up through the next \n separator in the pipe
# Author: Mark Lutz
# Last modified: 

# same as pipe1.py, but wrap pipe input in stdio file object to read by line, 
# and close unused pipe fds in both processes
