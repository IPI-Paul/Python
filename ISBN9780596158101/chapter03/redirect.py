...
# Example 3-9
# Shows a utility module that demonstrates polymorphism and it's liberal approach
# to data types accounts for much of the conciseness and flexibility of Python 
# code
# Author: Mark Lutz
# Last modified: 

"""
file-like objects that save standard output text in a string and provide standard
input text from a string; redirect runs a passed-in function with its output and 
input streams reset to these file-like class obkects;
"""
