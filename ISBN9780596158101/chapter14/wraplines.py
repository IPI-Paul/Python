...
# Example 14-7
# Implements general tools for wrapping long lines, at either a fixed column or 
# the first delimiter at or before a fixed column
# Author: Mark Lutz
# Last modified: 
...
4E caveat: this assumes str; supporting bytes might help avoid some decode;
################################################################################
"""
defaultsize = 80
...
def wrapText2(text, size=defaultsize):          # more uniform accross lines
...
def wrapLines2(lines, size=defaultsize):        # more uniform accross lines
...
if __name__ == '__main__':
    ...
    input('Press enter')        # paused if clicked