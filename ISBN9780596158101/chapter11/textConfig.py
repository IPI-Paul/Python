...
# Example 11-1
# Is PyEdit's user configuration module. Provides an initial look-and-feel other 
# than the default
# Author: Mark Lutz
# Last modified: 
...
# can also change font/colors from GUI menus, ad resize window when open;
...
# search case-insensitiver
caseinsens = True                               # default=1/True (on)

#-------------------------------------------------------------------------------
# 2.1: Unicode encoding behaviour and names for file opens and saves;
...
# (which is 'utf-8' on Windows, or 'ascii' or 'latin-1' on others line Unix);
# savesUseknownencoding: 0=No, 1=Yes for Save and SaveAs;
