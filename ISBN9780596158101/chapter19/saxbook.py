...
# Example 19-10
# Defines a SAX-based parsing procedure: its class implements callback methods 
# that will be called during the parse, and its top level code runs a parser
# Author: Mark Lutz
# Last modified: 
...
parser.parse('../sourceFiles/xml/ch19-books.xml')
