...
# Example 19-4
# A short test file that matches simple but representative pattern forms. Parts 
# of the pattern strings enclosed in parentheses delimit groups; the parts of the
# string they matched are available after the match
# Author: Mark Lutz
# Last modified: 
