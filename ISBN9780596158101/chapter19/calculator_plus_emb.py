...
# Example 19-22
# Adds a few extra buttons to PyCalc by embedding (i.e., attaching) it in 
# container
# Author: Mark Lutz
# Last modified: 
...
by embedding/composition, not subclassing; new buttons are added after entire 
CalcGui frame because of the packing order/options;
################################################################################
"""
...
import sys
sys.path.append('..')
from chapter10.widgets import frame, button, label
